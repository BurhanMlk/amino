...
const Login = () => {
    ...
    return (
        <div className="w-full max-w-[360px] md:max-w-[749px] bg-white md:rounded-[10px] md:shadow-[0px_1px_11px_3px_rgba(178,178,178,0.25)] p-0 md:p-12 sm:p-16 mx-auto my-10">
            <h1 className="text-[24px] md:text-[35px] font-semibold text-center text-[#08202C] mb-[27px] md:mb-[50px] font-['Poppins'] leading-tight md:leading-[55px]">Login</h1>

            <form className="flex flex-col items-center w-full">
                <div className="w-full space-y-[39px] mb-6">
                ...
                <div className="flex items-center justify-between w-full mb-[28px]">
                    <label className="flex items-center gap-[6px] cursor-pointer text-[#116190]">
                        <input
                            type="checkbox"
                            className="w-[22px] h-[22px] md:w-6 md:h-6 rounded-sm border-[#e2e2e2] text-[#116190] focus:ring-[#116190]"
                        />
                        <span className="text-[12px] md:text-[18px] font-normal font-['Poppins']">Remember me</span>
                    </label>
                    <a href="#" className="text-[12px] md:text-[18px] font-normal text-[#116190] hover:underline font-['Poppins']">
                        Forgot Password?
                    </a>
                </div>
                ...
                <div className="text-center">
                    <p className="text-[#7f7f80] text-[16px] md:text-[18px] font-normal flex items-center justify-center gap-[6px] font-['Poppins']">
                        ...
                        <Link to="/register" className="text-[#116190] font-normal flex items-center gap-[10px]">
                            Register
